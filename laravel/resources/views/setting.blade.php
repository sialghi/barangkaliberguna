    ...
    <form action="{{ route('update.setting') }}" method="POST" enctype="multipart/form-data">
        ...
        <table style="background-color: transparent;">
            ...
            @if (array_intersect(['mahasiswa'], $userRole))
                <tr>
                    ...
                    <td>
                        ...
                        @endphp
                        <select id="jalurMasuk" name="jalurMasuk" class="form-control form-control-sm" style="max-width: 500px;" disabled>
                            @if ($data->jalur_masuk)
                ...
                <td id="noHp">
                    <div class="d-flex flex-row">
                        <div class="d-flex flex-row" style="width: 30%;">
                            <div class="form-control form-control-sm px-1" style="width: 15%; background-color: #e9ecef;">+62</div>
                            <input type="text" name="noHp" class="form-control form-control-sm" style="width: 85%;" value="{{ substr($data->no_hp, 2) }}" disabled>
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="d-flex flex-row">
                        <input type="email" name="altEmail" class="form-control form-control-sm" style="width: 30%;" value="{{ $data->alt_email }}" disabled>
                    </div>
                </td>
            </tr>
        ...
        <div class="d-flex flex-row mt-4">
            <a href="{{ route('setting.edit') }}" class="btn btn-warning ml-2 text-white">Edit</a>
        </div>
    </form>
