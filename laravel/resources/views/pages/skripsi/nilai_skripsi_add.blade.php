    ...
    <table style=" background-color: transparent;">
        <tr>
            ...
            <td>
                ...
                <x-adminlte-input name="nim" id="nim" placeholder="Nomor Induk Mahasiswa" value="{{ old('nim') }}" type="number" autocomplete="off" disabled>
                    <x-slot name="prependSlot">
                        <div class="input-group-text bg-gradient-info">
        ...
        <tr>
            ...
            <td>
                ...
                <x-adminlte-input-date name="tanggalUjian" id="tanggalUjian" :config="$config" placeholder="Pilih tanggal sidang..." value="{{ old('tanggalUjian') }}" autocomplete="off">
                    <x-slot name="prependSlot">
        ...
        <tr>
            ...
            <td>
                ...
                <x-adminlte-input-date name="jamUjian" id="jamUjian" :config="$configJam" placeholder="Pilih jam ujian..." value="{{ old('jamUjian') }}" autocomplete="off">
                    <x-slot name="prependSlot">
        ...
        <tr>
            <td>
                <div id="ruanganUjian" style="display: none;">
                    ...
                    <x-adminlte-input name="ruanganUjian" id="ruanganUjian" placeholder="Masukkan ruangan ujian..."  value="{{ old('ruanganUjian') }}" autocomplete="off">
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-gradient-info">
                ...
                <div id="linkUjian" style="display: none;">
                    ...
                    <x-adminlte-input name="linkUjian" id="linkUjian" placeholder="Masukkan link webinar..."  value="{{ old('linkUjian') }}" autocomplete="off">
                        <x-slot name="prependSlot">
            ...
            $('#pendaftarSkripsiSelect').change(function() {
                ...
                if (pendaftarId) {
                    ...
                    $.get(apiUrl, function(data) {
                        ...
                        $('#pembimbing1').html('<option value="'+data.pendaftaranSkripsi.pembimbing1.id+'" selected hidden>'+data.pendaftaranSkripsi.pembimbing1.name+'</option>@foreach ($namaDosen as $dosen) <option value="{{ $dosen->id }}" {{ old('pembimbing1') == $dosen->id ? 'selected' : '' }}>{{ $dosen->name }}</option> @endforeach')
                        $('#pembimbing2').html('<option value="'+data.pendaftaranSkripsi.pembimbing2.id+'" selected hidden>'+data.pendaftaranSkripsi.pembimbing2.name+'</option>@foreach ($namaDosen as $dosen) <option value="{{ $dosen->id }}" {{ old('pembimbing2') == $dosen->id ? 'selected' : '' }}>{{ $dosen->name }}</option> @endforeach')

                        if (data.pendaftaranSkripsi.calon_penguji1) {
                            $('#penguji1').html('<option value="'+data.pendaftaranSkripsi.calon_penguji1.id+'" selected hidden>'+data.pendaftaranSkripsi.calon_penguji1.name+'</option>@foreach ($namaDosen as $dosen) <option value="{{ $dosen->id }}" {{ old('penguji1') == $dosen->id ? 'selected' : '' }}>{{ $dosen->name }}</option> @endforeach')
                        } else {
                        ...
                        if (data.pendaftaranSkripsi.calon_penguji2) {
                            $('#penguji2').html('<option value="'+data.pendaftaranSkripsi.calon_penguji2.id+'" selected hidden>'+data.pendaftaranSkripsi.calon_penguji2.name+'</option>@foreach ($namaDosen as $dosen) <option value="{{ $dosen->id }}" {{ old('penguji2') == $dosen->id ? 'selected' : '' }}>{{ $dosen->name }}</option> @endforeach')
                        } else {
