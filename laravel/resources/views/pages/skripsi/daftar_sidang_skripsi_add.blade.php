...
@section('content')
    ...
    <form id="formSubmitDaftarSkripsi" action="{{ route('store.daftar.sidang.skripsi') }}" method="POST"
            ...
            <tr>
                <td colspan="2">
                    ...
                    <x-adminlte-input-date id="waktuUjian" name="waktuUjian" :config="$configTanggal"
                        placeholder="Pilih tanggal dan waktu ujian..." autocomplete="off" value="{{ old('waktuUjian') }}">
                        <x-slot name="prependSlot">
        ...
        <table class="d-flex justify-content-center mt-3">
            <tr>
                <td>
                    ...
                    <x-adminlte-input-file name="fileTranskripNilai" placeholder="Klik di sini..." disable-feedback
                ...
                <td>
                    ...
                    <x-adminlte-input-file name="fileNaskahSkripsi" placeholder="Klik di sini..." disable-feedback
                        onchange="displayFileName(this)" accept=".pdf">
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-gradient-primary">
                                <i class="fas fa-file-upload"></i>
            ...
            <tr>
                <td>
                    ...
                    <label for="filePersetujuanPengujiSemhas">Persetujuan Penguji Seminar Hasil (PDF) <span
