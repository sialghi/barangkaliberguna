<x-adminlte-modal id="hapusPenilaian" title="Hapus Data" theme="red" size='lg'>
...
@push('js')
   <script>
      $(document).ready(function() {
         $('#hapusPenilaian').on('show.bs.modal', function(event) {
            let button = $(event.relatedTarget);
            let rowId = button.data('row-id');

            let deletePendaftaran = "{{ route('delete.nilai.sidang.skripsi', ['id' => ':id']) }}";
