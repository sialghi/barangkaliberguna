    ...
    <table style="background-color: transparent;">
        <tr>
            <td>
                ...
                <x-adminlte-select-bs name="kategoriTugasAkhir" label-class="text-black"
                    igroup-size="md" data-title="Pilih Kategori Tugas Akhir..." data-style='border: 1px solid #ced4da; background-color: #fff;'
