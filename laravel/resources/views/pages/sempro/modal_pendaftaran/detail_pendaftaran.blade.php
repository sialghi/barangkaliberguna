...
<x-adminlte-modal id="detailPendaftaran" title="Lihat Detail" theme="blue" size='lg'>
   <div class="modal-body">
      <table>
         ...
         <tr>
            <td colspan="2">
               <x-adminlte-input id="kategoriTugasAkhir" name="kategoriTugasAkhir" label="Kategori Tugas Akhir" placeholder="Kategori Tugas Akhir" disabled>
               </x-adminlte-input>
            </td>
         </tr>
         <tr>
            <td colspan="2">
               <x-adminlte-textarea id="proposalJudul" name="proposalJudul" label="Judul Proposal" placeholder="Judul Proposal" disabled>
                  <x-slot name="prependSlot">
                     <div class="input-group-text bg-gradient-info">
   ...
   $(document).ready(function() {
      $('#detailPendaftaran').on('show.bs.modal', function(event) {
         ...
         $.get(apiUrl, function(data) {
            ...
            if (data.kategori_ta) {
               modal.find('#kategoriTugasAkhir').val(`${data.kategori_ta.kode} - ${data.kategori_ta.nama}`);
            }
