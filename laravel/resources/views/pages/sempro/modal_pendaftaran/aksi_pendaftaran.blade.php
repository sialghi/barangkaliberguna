   ...
   <div class="modal-body">
      <form method="POST" id="aksiFormPendaftaran" class="d-flex flex-column justify-content-center">
         ...
         <div class="d-flex justify-content-center">
            <button type="button" id="aksiSetujuiButton" class="btn btn-success">Setujui</button>
...
<script>
   $(document).ready(function() {
         $('#aksiPendaftaran').on('show.bs.modal', function(event) {
            ...
            $('#aksiSetujuiButton').on('click', function() {
               let approve = "{{ route('approve.daftar.seminar.proposal', ['id' => ':id']) }}";
            ...
            $('#aksiTolakButton').on('click', function() {
               let reject = "{{ route('reject.daftar.seminar.proposal', ['id' => ':id']) }}";
            ...
            $('#aksiRevisiButton').on('click', function() {
               let revise = "{{ route('revise.daftar.seminar.proposal', ['id' => ':id']) }}";
