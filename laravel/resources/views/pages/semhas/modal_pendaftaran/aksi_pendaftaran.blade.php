   ...
   $(document).ready(function() {
         $('#aksiPendaftaran').on('show.bs.modal', function(event) {
            ...
            $('#aksiSetujuiButton').on('click', function() {
               let approve = "{{ route('approve.daftar.seminar.hasil', ['id' => ':id']) }}";
            ...
            $('#aksiTolakButton').on('click', function() {
               let reject = "{{ route('reject.daftar.seminar.hasil', ['id' => ':id']) }}";
            ...
            $('#aksiRevisiButton').on('click', function() {
               let revise = "{{ route('revise.daftar.seminar.hasil', ['id' => ':id']) }}";
