...
@section('content')
    ...
    <form id="formEditDaftarSemhas" action="{{ route('update.daftar.seminar.hasil', ['id' => $pendaftaranSemhas->id]) }}"
        ...
        <table class="mt-4">
                ...
                <td colspan="2">
                    ...
                    <x-adminlte-select-bs name="pembimbing1" label-class="text-black" igroup-size="md"
                        ...
                        @if ($pendaftaranSemhas->pembimbing1)
                            <option value="{{ $pendaftaranSemhas->pembimbing1->id }}" selected disabled>
                                {{ $pendaftaranSemhas->pembimbing1->name }}</option>
                        @else
            ...
            <tr>
                <td colspan="2">
                    ...
                    <x-adminlte-input-date id="waktuSeminar" name="waktuSeminar" :config="$configTanggal"
                        placeholder="Pilih tanggal dan waktu ujian..." autocomplete="off"
                        value="{{ $pendaftaranSemhas->waktu_seminar }}">
                        <x-slot name="prependSlot">
                ...
                <td colspan="2">
                    ...
                    <x-adminlte-select-bs name="pembimbing2" label-class="text-black" igroup-size="md"
                        ...
                        @if ($pendaftaranSemhas->pembimbing2)
                            <option value="{{ $pendaftaranSemhas->pembimbing2->id }}" selected disabled>
                                {{ $pendaftaranSemhas->pembimbing2->name }}</option>
                        @else
            ...
            <tr>
                <td colspan="2">
                    ...
                    <x-adminlte-select-bs name="dosenPembimbingAkademik" label-class="text-black" igroup-size="md"
                        data-title="Pilih Dosen Pembimbing Akademik..." data-live-search
                        data-style='border: 1px solid #ced4da; background-color: #fff;'
                        ...
                        @if ($pendaftaranSemhas->dosenPembimbingAkademik)
                            <option value="{{ $pendaftaranSemhas->dosenPembimbingAkademik->id }}" selected disabled>
                                {{ $pendaftaranSemhas->dosenPembimbingAkademik->name }}</option>
                        @else
                            <option value="" selected disabled hidden>Pilih Dosen Pembimbing Akademik</option>
                        @endif
                        @foreach ($namaDosenAkademik as $dosen)
                            <option value="{{ $dosen->id }}"
                                {{ old('dosenPembimbingAkademik') == $dosen->id ? 'selected' : '' }}>
                                {{ $dosen->display_name }}
                            </option>
                        @endforeach
                    </x-adminlte-select-bs>
                  ...
                  <x-adminlte-select name="dosenPembimbingAkademik">
                     ...
                     @endif
                     @foreach ($namaDosen as $dosen)
                        <option value="{{ $dosen->id }}" {{ old('dosenPembimbingAkademik') == $dosen->id ? 'selected' : '' }}>{{ $dosen->display_name }}</option>
                    @endforeach
                     <x-slot name="prependSlot">
                           <div class="input-group-text bg-gradient-purple">
                              <i class="fas fa-user"></i>
                ...
                <td colspan="2">
                    ...
                    <x-adminlte-select-bs name="calonPenguji1" label-class="text-black" igroup-size="md"
                        data-title="Pilih Calon Dosen Penguji 1..." data-live-search
                        data-style='border: 1px solid #ced4da; background-color: #fff;'
                        ...
                        @if ($pendaftaranSemhas->calonPenguji1)
                            <option value="{{ $pendaftaranSemhas->calonPenguji1->id }}" selected disabled>
                                {{ $pendaftaranSemhas->calonPenguji1->name }}</option>
                        @else
                            <option value="" selected disabled hidden>Pilih Calon Dosen Penguji 1</option>
                        @endif
                        @foreach ($namaDosen as $dosen)
                            <option value="{{ $dosen->id }}"
                                {{ old('calonPenguji1') == $dosen->id ? 'selected' : '' }}>{{ $dosen->display_name }}
                            </option>
                        @endforeach
                    </x-adminlte-select-bs>
                  ...
                  <x-adminlte-select name="calonPenguji1">
                     ...
                     @endif
                     @foreach ($namaDosen as $dosen)
                        <option value="{{ $dosen->id }}" {{ old('calonPenguji1') == $dosen->id ? 'selected' : '' }}>{{ $dosen->display_name }}</option>
                    @endforeach
                     <x-slot name="prependSlot">
                           <div class="input-group-text bg-gradient-teal">
                              <i class="fas fa-user"></i>
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <x-adminlte-select-bs name="calonPenguji2" label-class="text-black" igroup-size="md"
                        data-title="Pilih Calon Dosen Penguji 2..." data-live-search
                        data-style='border: 1px solid #ced4da; background-color: #fff;'
                        ...
                        @if ($pendaftaranSemhas->calonPenguji2)
                            <option value="{{ $pendaftaranSemhas->calonPenguji2->id }}" selected disabled>
                                {{ $pendaftaranSemhas->calonPenguji2->name }}</option>
                        @else
                            <option value="" selected disabled hidden>Pilih Calon Dosen Penguji 2</option>
                        @endif
                        @foreach ($namaDosen as $dosen)
                            <option value="{{ $dosen->id }}"
                                {{ old('calonPenguji2') == $dosen->id ? 'selected' : '' }}>{{ $dosen->display_name }}
                            </option>
                        @endforeach
                    </x-adminlte-select-bs>
                  ...
                  <x-adminlte-select name="calonPenguji2">
                     ...
                     @endif
                     @foreach ($namaDosen as $dosen)
                        <option value="{{ $dosen->id }}" {{ old('calonPenguji2') == $dosen->id ? 'selected' : '' }}>{{ $dosen->display_name }}</option>
                    @endforeach
                     <x-slot name="prependSlot">
                           <div class="input-group-text bg-gradient-teal">
                              <i class="fas fa-user"></i>
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <x-adminlte-input name="calonPenguji3" placeholder="Nama calon dosen penguji di luar prodi..."
                        value="{{ $pendaftaranSemhas->calon_penguji_3_name }}" autocomplete="off">
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-gradient-teal">
                                <i class="fas fa-user"></i>
                            </div>
        ...
        <table class="d-flex justify-content-center mt-3">
            <tr>
                <td>
                    <label class="mb-1" id="fileTranskripNilai" for="fileTranskripNilai">Transkrip Nilai (PDF) <span
                            class="text-red">*</span>
                        <br>
                        <span class="text-xs">File sekarang:</span>
                    </label>
                    <a href="/api/seminar_hasil/daftar/berkas/{{ $pendaftaranSemhas->file_transkrip_nilai }}"
                        target="_blank" class="btn btn-default px-1 d-flex align-items-center mb-1"
                        style="max-width: 220px;"
                        title="{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas->file_transkrip_nilai) }}"><span
                            style="max-width: 180px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas->file_transkrip_nilai) }}</span><i
                            class="fas fa-lg fa-fw fa-file-pdf text-red"></i></a>
                ...
                <td>
                    <label class="mb-1" id="fileNaskahSkripsi" for="fileNaskahSkripsi">Naskah Tugas Akhir (PDF) <span
                            class="text-red">*</span>
                        <br>
                        <span class="text-xs">File sekarang:</span>
                    </label>
                    <a href="/api/seminar_hasil/daftar/berkas/{{ $pendaftaranSemhas->file_naskah_skripsi }}"
                        target="_blank" class="btn btn-default px-1 d-flex align-items-center mb-1"
                        style="max-width: 220px;"
                        title="{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas->file_naskah_skripsi) }}"><span
                            style="max-width: 180px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas->file_naskah_skripsi) }}</span><i
                            class="fas fa-lg fa-fw fa-file-pdf text-red"></i></a>
                ...
                <td>
                    <label class="mb-1" id="filePengesahanSkripsi" for="filePengesahanSkripsi">Lembar Pengesahan Tugas
                        Akhir (PDF) <span class="text-red">*</span>
                        <br>
                        <span class="text-xs">File sekarang:</span>
                    </label>
                    <a href="/api/seminar_hasil/daftar/berkas/{{ $pendaftaranSemhas->file_pengesahan_skripsi }}"
                        target="_blank" class="btn btn-default px-1 d-flex align-items-center mb-1"
                        style="max-width: 220px;"
                        title="{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas->file_pengesahan_skripsi) }}"><span
                            style="max-width: 180px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas->file_pengesahan_skripsi) }}</span><i
                            class="fas fa-lg fa-fw fa-file-pdf text-red"></i></a>
            ...
            <tr>
                <td>
                    ...
                    <label class="mb-1" id="filePernyataanKaryaSendiri" for="filePernyataanKaryaSendiri">Surat
                        Pernyataan Karya Sendiri (PDF) <span class="text-red">*</span>
                        <br>
                        <span class="text-xs">File sekarang:</span>
                    </label>
                    <a href="/api/seminar_hasil/daftar/berkas/{{ $pendaftaranSemhas->file_pernyataan_karya_sendiri }}"
                        target="_blank" class="btn btn-default px-1 d-flex align-items-center mb-1"
                        style="max-width: 220px;"
                        title="{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas->file_pernyataan_karya_sendiri) }}"><span
                            style="max-width: 180px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas->file_pernyataan_karya_sendiri) }}</span><i
                            class="fas fa-lg fa-fw fa-file-pdf text-red"></i></a>
                    <x-adminlte-input-file name="filePernyataanKaryaSendiri"
                        placeholder="Klik di sini untuk mengubah file..." disable-feedback
                ...
                <td>
                    ...
                    <label class="mb-1" id="fileSertifikatToafl" for="fileSertifikatToafl">Sertifikat TOAFL (PBA) (PDF)
                    ...
                    @if ($pendaftaranSemhas->file_sertifikat_toafl_3)
                        @for ($i = 1; $i <= 3; $i++)
                            <a href="/api/seminar_hasil/daftar/berkas/{{ $pendaftaranSemhas['file_sertifikat_toafl_' . $i] }}"
                                target="_blank" class="btn btn-default px-1 d-flex align-items-center mb-1"
                                style="max-width: 220px;"
                                title="{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas['file_sertifikat_toafl_' . $i]) }}"><span
                                    style="max-width: 180px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas['file_sertifikat_toafl_' . $i]) }}</span><i
                                    class="fas fa-lg fa-fw fa-file-pdf text-red"></i></a>
                        @endfor
                    @else
                        <a href="/api/seminar_hasil/daftar/berkas/{{ $pendaftaranSemhas->file_sertifikat_toafl_1 }}"
                            target="_blank" class="btn btn-default px-1 d-flex align-items-center mb-1"
                            style="max-width: 220px;"
                            title="{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas->file_sertifikat_toafl_1) }}"><span
                                style="max-width: 180px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas->file_sertifikat_toafl_1) }}</span><i
                                class="fas fa-lg fa-fw fa-file-pdf text-red"></i></a>
                    @endif
                    ...
                    <small class="text-muted" style="max-width: 400px; word-wrap: break-word; display: block;">
                        Syarat Lulus nilai TOAFL <b>375</b>, jika belum memenuhi maka mahasiswa wajib melampirkan tiga
                        berkas akreditasi nilai TOAFL
                    </small>
                </td>
                <td>
                    <label class="mb-1" id="fileSertifikatToefl" for="fileSertifikatToefl">Sertifikat TOEFL (PBI) (PDF)
                        <span class="text-red">*</span>
                        <br>
                        <span class="text-xs">File sekarang:</span>
                    </label>
                    @if ($pendaftaranSemhas->file_sertifikat_toefl_3)
                        @for ($i = 1; $i <= 3; $i++)
                            <a href="/api/seminar_hasil/daftar/berkas/{{ $pendaftaranSemhas['file_sertifikat_toefl_' . $i] }}"
                                target="_blank" class="btn btn-default px-1 d-flex align-items-center mb-1"
                                style="max-width: 220px;"
                                title="{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas['file_sertifikat_toefl_' . $i]) }}"><span
                                    style="max-width: 180px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas['file_sertifikat_toefl_' . $i]) }}</span><i
                                    class="fas fa-lg fa-fw fa-file-pdf text-red"></i></a>
                        @endfor
                    @else
                        <a href="/api/seminar_hasil/daftar/berkas/{{ $pendaftaranSemhas->file_sertifikat_toefl_1 }}"
                            target="_blank" class="btn btn-default px-1 d-flex align-items-center mb-1"
                            style="max-width: 220px;"
                            title="{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas->file_sertifikat_toefl_1) }}"><span
                                style="max-width: 180px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ preg_replace('/^\d+_\d+_/', '', $pendaftaranSemhas->file_sertifikat_toefl_1) }}</span><i
                                class="fas fa-lg fa-fw fa-file-pdf text-red"></i></a>
                    @endif
                    </label>
                    ...
                    <small class="text-muted" style="max-width: 400px; word-wrap: break-word; display: block;">
                        Syarat Lulus nilai TOEFL <b>450</b>, jika belum memenuhi maka mahasiswa wajib melampirkan tiga
                        berkas akreditasi nilai TOEFL
                    </small>
                </td>
            </tr>
        </table>
