...
@section('content')
    ...
    <form id="formSubmitDaftarSemhas" action="{{ route('store.daftar.seminar.hasil') }}" method="POST"
        ...
        <table class="mt-4">
            ...
            <tr>
                <td colspan="2">
                    ...
                    <x-adminlte-input-date id="waktuSeminar" name="waktuSeminar" :config="$configTanggal"
                        placeholder="Pilih tanggal dan waktu ujian..." autocomplete="off" value="{{ old('waktuSeminar') }}">
                        <x-slot name="prependSlot">
            ...
            <tr>
                ...
                <td colspan="2">
                    {{-- Calon Penguji 1 --}}
                    <label for="calonPenguji1">Calon Dosen Penguji 1 <span class="text-grey small">(opsional)</span>
                    </label>
                    <x-adminlte-select-bs name="calonPenguji1" label-class="text-black" igroup-size="md"
                        data-title="Ajukan Calon Dosen Penguji 1..." data-live-search
                        data-style='border: 1px solid #ced4da; background-color: #fff;'
            ...
            <tr>
                ...
                <td colspan="2">
                    {{-- Calon Penguji 2 --}}
                    <label for="calonPenguji2">Calon Dosen Penguji 2 <span class="text-grey small">(opsional)</span>
                    </label>
                    <x-adminlte-select-bs name="calonPenguji2" label-class="text-black" igroup-size="md"
                        data-title="Ajukan Calon Dosen Penguji 2..." data-live-search
                        data-style='border: 1px solid #ced4da; background-color: #fff;'
            ...
            <tr>
                ...
                <td colspan="2">
                    {{-- Calon Penguji 3 --}}
                    <label for="calonPenguji3">Calon Dosen Penguji 3 <span class="text-grey small">(opsional)</span>
                    </label>
                    <x-adminlte-input name="calonPenguji3" placeholder="Nama calon dosen penguji di luar prodi..."
                        value="{{ old('calonPenguji3') }}" autocomplete="off">
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-gradient-teal">
                                <i class="fas fa-user"></i>
                            </div>
        ...
        <table class="d-flex justify-content-center mt-3">
            <tr>
                ...
                <td>
                    <label for="filePengesahanSkripsi">Lembar Pengesahan Tugas Akhir (PDF) <span
            ...
            <tr>
                <td>
                    <label for="filePernyataanKaryaSendiri">Surat Pernyataan Karya Sendiri (PDF) <span
                            class="text-red">*</span></label>
        ...
        <br>
        <x-adminlte-button id="submitPendaftaran" type="submit" name="submit" label="Submit" theme="primary"
