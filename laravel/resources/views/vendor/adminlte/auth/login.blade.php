...
@section('auth_body')
    <form action="{{ $login_url }}" method="post">
        ...
        <div class="input-group mb-3" style="background-color: #e6f4fd;">
            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" style="background-color: #e6f4fd;"
        ...
        {{-- Password field --}}
        <div class="input-group mb-3" style="background-color: #e6f4fd;">
            <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" style="background-color: #e6f4fd;"
