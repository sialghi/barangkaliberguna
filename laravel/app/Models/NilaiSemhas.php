...
class NilaiSemhas extends Model
{
    ...
    protected $fillable = [
        ...
        'id_mahasiswa',
        'judul_skripsi', 'id_pendaftaran_semhas',
        'tanggal_seminar', 'jam_seminar', 'ruangan_seminar', 'link_seminar',
    ];
    ...
    {
        return $this->belongsTo(PendaftaranSemhas::class, 'id_pendaftaran_semhas');
    }
}
